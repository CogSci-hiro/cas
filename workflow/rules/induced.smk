FPP_SPP_CONF_DISC_ALPHA_BETA_FPP_LOCKED_DOWNSAMPLED_SUMMARY_OUTPUTS = expand(
    (
        f"{OUT_DIR}/{FPP_SPP_CONF_DISC_ALPHA_BETA_FPP_LOCKED_LMEEEG_INDUCED_SUBDIR}/"
        "sub-{subject}/summary.json"
    ),
    subject=INDUCED_EPOCH_SUBJECTS,
)
FPP_SPP_CONF_DISC_ALPHA_BETA_SPP_LOCKED_DOWNSAMPLED_SUMMARY_OUTPUTS = expand(
    (
        f"{OUT_DIR}/{FPP_SPP_CONF_DISC_ALPHA_BETA_SPP_LOCKED_LMEEEG_INDUCED_SUBDIR}/"
        "sub-{subject}/summary.json"
    ),
    subject=INDUCED_EPOCH_SUBJECTS,
)
...
rule downsample_fpp_locked_fpp_spp_conf_disc_induced_epochs_subject:
    input:
...
rule downsample_spp_locked_fpp_spp_conf_disc_induced_epochs_subject:
    input:
...
rule build_induced_sensor_conf_disc_fpp_locked:
    input:
        epochs=EPOCH_OUTPUTS,
        induced=FPP_SPP_CONF_DISC_ALPHA_BETA_FPP_LOCKED_DOWNSAMPLED_SUMMARY_OUTPUTS,
        config=FPP_SPP_CONF_DISC_ALPHA_BETA_FPP_LOCKED_LMEEEG_CONFIG_PATH,
    output:
        summary=FPP_SPP_CONF_DISC_ALPHA_BETA_FPP_LOCKED_LMEEEG_SUMMARY_OUTPUT,
        model_summaries=FPP_SPP_CONF_DISC_ALPHA_BETA_FPP_LOCKED_LMEEEG_MODEL_SUMMARY_OUTPUTS,
        contrast=FPP_SPP_CONF_DISC_ALPHA_BETA_FPP_LOCKED_LMEEEG_CONTRAST_OUTPUTS,
    run:
        import os
...
rule build_induced_sensor_conf_disc_spp_locked:
    input:
        epochs=EPOCH_OUTPUTS,
        induced=FPP_SPP_CONF_DISC_ALPHA_BETA_SPP_LOCKED_DOWNSAMPLED_SUMMARY_OUTPUTS,
        config=FPP_SPP_CONF_DISC_ALPHA_BETA_SPP_LOCKED_LMEEEG_CONFIG_PATH,
    output:
        summary=FPP_SPP_CONF_DISC_ALPHA_BETA_SPP_LOCKED_LMEEEG_SUMMARY_OUTPUT,
        model_summaries=FPP_SPP_CONF_DISC_ALPHA_BETA_SPP_LOCKED_LMEEEG_MODEL_SUMMARY_OUTPUTS,
        contrast=FPP_SPP_CONF_DISC_ALPHA_BETA_SPP_LOCKED_LMEEEG_CONTRAST_OUTPUTS,
    run:
        import os
...
INDUCED_POWER_OUTPUTS = [
    ...
    *INDUCED_CONF_DISC_FPP_LOCKED_SOURCE_EPOCH_OUTPUTS,
    *INDUCED_CONF_DISC_SPP_LOCKED_SOURCE_EPOCH_OUTPUTS,
    *INDUCED_CONF_DISC_FPP_LOCKED_EPOCH_SUMMARY_OUTPUTS,
    *INDUCED_CONF_DISC_SPP_LOCKED_EPOCH_SUMMARY_OUTPUTS,
    *_induced_epoch_band_summary_outputs(
    ...
    *FPP_SPP_CONF_DISC_ALPHA_BETA_FPP_LOCKED_DOWNSAMPLED_SUMMARY_OUTPUTS,
    *FPP_SPP_CONF_DISC_ALPHA_BETA_SPP_LOCKED_DOWNSAMPLED_SUMMARY_OUTPUTS,
